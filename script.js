...
message.innerHTML =
  'We implement cookies for improved functionalities. <button class="btn btn--close-cookie">Got it!</button>';
...
//making the nav links fade out when we hover by passing arguments to the eventhandler
